...
const translationView_1 = require("./translationView");
...
function activate(context) {
    // 注册 WebView 提供者
    const provider = new translationView_1.TranslationViewProvider(context);
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('translationView', provider));
}
